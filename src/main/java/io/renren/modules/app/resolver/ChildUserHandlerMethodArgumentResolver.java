...
import io.renren.modules.app.annotation.ChildLogin;
import io.renren.modules.app.annotation.ChildLoginUser;
...
public class ChildUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterType().isAssignableFrom(UserEntity.class) && parameter.hasParameterAnnotation(ChildLoginUser.class);
    }
