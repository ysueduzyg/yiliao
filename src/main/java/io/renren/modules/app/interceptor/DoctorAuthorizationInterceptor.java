 ...
 */
@Component
public class DoctorAuthorizationInterceptor extends HandlerInterceptorAdapter {
    @Autowired
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        DoctorLogin annotation;
        if(handler instanceof HandlerMethod) {
            annotation = ((HandlerMethod) handler).getMethodAnnotation(DoctorLogin.class);
        }else{
            return true;
        }
